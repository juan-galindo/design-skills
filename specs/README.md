...
| **Pattern** | Copy [`_template-pattern.md`](_template-pattern.md) → `patterns/{id}.md`. Set `category: pattern`, `relationships.applies_to`. See [`patterns/CLAUDE.md`](patterns/CLAUDE.md). Pilot: [`patterns/bullet-points.md`](patterns/bullet-points.md). |
