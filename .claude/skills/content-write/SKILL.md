...
Al iniciar esta habilidad, lee los siguientes archivos de referencia con el tool `Read` para cargar el contexto completo antes de escribir cualquier copy:

1. `~/.claude/skills/content-write/references/bitso-tone-of-voice.md` — Los tres pilares de voz de Bitso (Confident yet Approachable, Inspiring but Down to Earth, Fresh with Purpose), el FEE Framework, ejemplos en español y guía de cuándo usar cada pilar según el tipo de contenido.
2. `~/.claude/skills/content-write/references/system-thinking.md` — Framework de pensamiento sistémico, cadenas de contenido, arcos emocionales y heurísticas.
3. `~/.claude/skills/content-write/references/ux-writing-principles.md` — Principios de claridad, concisión, consistencia, errores, empty states, CTAs, onboarding, notificaciones y placeholders en es_MX fintech.
4. `~/.claude/skills/content-review/references/compliance-mx.md` — Términos prohibidos, disclaimers requeridos, terminología correcta y checklist pre-publicación para fintech/crypto en México.

No escribas copy antes de haber cargado estos tres archivos.
...
Consulta [references/system-thinking.md](references/system-thinking.md) para el framework completo.
...
La voz de Bitso tiene tres pilares. Cada pieza de copy usa uno o una combinación de ellos según el contexto. Consulta [references/bitso-tone-of-voice.md](references/bitso-tone-of-voice.md) para los detalles completos, ejemplos y checklists.
...
Consulta `~/.claude/skills/content-review/references/compliance-mx.md` para la lista completa.
